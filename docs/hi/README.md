...
| 4 | **रिले बोर्ड** (active-LOW, opto-isolated)<br><img src="../assets/hardware/relay_module.png" width="240"> | पंपों को ON/OFF करने देता है। Pi ख़ुद से पंप की पावर नहीं दे सकता। | **5V ट्रिगर, ऑप्टो-आइसोलेटेड** लिखा हो — वरना 3.3V पिन से काम नहीं करेगा। |
...
बर्स्ट सिंचाई, हर पौधे के लिए एक पंप — दो तरह से चलाएं:

- **मैनुअल** — डैशबोर्ड के **Overview** टैब में किसी पौधे का कार्ड टैप करें और उसका पंप तुरंत चलाएं।
- **ऑटो-मोड** — ऐप हर नमी सेंसर पर नज़र रखता है और ख़ुद पानी देता है: मिट्टी **45 %** पर पहुँचते ही बर्स्ट शुरू, **65 %** पर रुक जाता है, और कोई रीडिंग कभी **70 %** पार करे तो पंप **हार्ड-लॉक** हो जाता है — ताकि कोई अटका हुआ सेंसर पौधे में पानी न भर दे।

हर पौधा एक रिले चैनल और एक नमी सेंसर से जुड़ा है (ऊपर **वायरिंग** सेक्शन देखें)। पंप ऑप्टो-आइसोलेटेड रिले बोर्ड से ऑन/ऑफ होते हैं — Pi सिर्फ़ रिले चलाता है, पंप की पावर कभी नहीं। एक पौधे से शुरू करें और नीचे दिए **"+ Add sensors"** से रनटाइम पर फार्म बढ़ाएं; FLORA भी नाम से किसी पौधे को पानी दे सकती है, बंद कर सकती है और शेड्यूल कर सकती है।
...
## FLORA AI असिस्टेंट
*Farm Live Operation and Reasoning Assistant (फ़ार्म लाइव ऑपरेशन एंड रीज़निंग असिस्टेंट)*

![FLORA प्रीव्यू](../assets/FLORA_preview.jpeg)

FLORA डैशबोर्ड का चैट टैब है — पर यह केवल जवाब नहीं देती, असल में फार्म पर एक्शन करती है। यह साधारण भाषा के आदेश समझती है:
...
नीचे दी हर क्षमता किसी असली टूल से जुड़ी है जो सेंसर, रिले, कैमरा, इवेंट डेटाबेस या ईमेल कतार को छूता है। जब कोई क्लाउड LLM उपलब्ध न हो, FLORA डिटरमिनिस्टिक कीवर्ड रूटिंग पर लौट आती है — हर क्षमता ऑफ़लाइन भी काम करती रहती है।

### क्षमताएँ

| क्षमता | क्या करती है |
|--------|--------------|
| **पूरा फार्म विश्लेषण** | हर एक्टिव पौधे की लाइव मॉइस्चर, पंप स्थिति, सेंसर हेल्थ, सिक्योरिटी कैमरा स्थिति और FarmMonitor कैमरा रिपोर्ट — माँगने पर तुरंत। |
| **हिस्ट्री प्रश्न** | *"पिछले हफ़्ते क्या हुआ?"*, *"पिछले 3 दिन की रोग डिटेक्शन दिखाओ"* — इवेंट डेटाबेस से, जब तक इवेंट रखे हैं तब तक। |
| **सिंचाई नियंत्रण** | किसी भी पौधे का पानी अलग से चालू / बंद — *"plant C पर पानी दो"*, *"pump B बंद करो"*। |
| **गार्ड नियंत्रण** | सिक्योरिटी कैमरा + डुअल-बज़र सायरन को ऑन / ऑफ — *"guard on"*, *"मैं जा रहा हूँ"*, *"मैं वापस हूँ"*। |
| **FarmMonitor स्कैन** | प्लांट हेल्थ और कटाई-तैयार स्कैन माँगने पर — *"अभी स्कैन करो"*, *"स्ट्रॉबेरी देखो"*। |
| **ईमेल** | डिटेक्शन फ़ोटो, स्कैन रिज़ल्ट या रिपोर्ट अटैचमेंट कॉन्फ़िगर किए गए ऑपरेटर पते पर भेज देती है। |
| **PDF रिपोर्ट** | फार्म स्थिति की डाउनलोडेबल PDF बनाती है और (वैकल्पिक) उसी कॉल में ईमेल भी कर देती है। |
| **शेड्यूलिंग** | ऊपर के किसी भी काम को बाद के लिए शेड्यूल — *"2 घंटे बाद plant A पर पानी दो"*, *"रोज़ सुबह 6 बजे स्कैन करो"*। |
| **क्लाउड या ऑफ़लाइन** | क्लाउड मोड: Groq / Cerebras / Mistral / Gemini में से कोई एक नैचुरल-लैंग्वेज समझ के लिए। ऑफ़लाइन मोड: डिटरमिनिस्टिक कीवर्ड रूटिंग — ऊपर की हर क्षमता काम करती है। |

### आर्किटेक्चर

FLORA तीन सहयोगी लेयरों में चलती है:
...
Wi-Fi की पहुँच से बाहर हों तब भी LoRa मेश पर FLORA से बात करें — पूरी तरह ऑफ़-ग्रिड। `.env` में `MESH_ENABLED=true` सेट करें और `MESH_HOST` को अपने नोड पर पॉइंट करें; FLORA किसी भी चैनल या DM पर सुनती है और सिर्फ़ भेजने वाले को जवाब देती है।

<p align="center">
  <img src="../img/meshtastic-flora-proof.jpg" alt="Meshtastic ↔ FLORA असली LoRa चैट" width="520">
</p>

`main.py` और `main-hailo.py` दोनों Meshtastic ↔ FLORA ब्रिज को **एक ही प्रोसेस के अंदर** स्टार्ट करते हैं — अलग सर्विस चलाने की ज़रूरत नहीं। ब्रिज:
...
Meshtastic लाइब्रेरी न हो या कनेक्शन टूट जाए, ब्रिज सिर्फ़ चेतावनी लॉग करेगा — `main.py` चलता रहेगा, डैशबोर्ड कभी ब्लॉक नहीं होगा। `MESH_*` के सारे विकल्प (allowed nodes, reply mode, channel filter) `.env.example` में हैं।
