...
FLORA डैशबोर्ड का चैट टैब है — पर यह केवल जवाब नहीं देती, असल में फार्म पर एक्शन करती है। नीचे दी हर क्षमता किसी असली टूल से जुड़ी है जो सेंसर, रिले, कैमरा, इवेंट डेटाबेस या ईमेल कतार को छूता है। जब कोई क्लाउड LLM उपलब्ध न हो, FLORA डिटरमिनिस्टिक कीवर्ड रूटिंग पर लौट आती है — हर क्षमता ऑफ़लाइन भी काम करती रहती है।

| क्षमता | FLORA क्या कर सकती है |
|--------|-----------------------|
...
| **हिस्ट्री प्रश्न** | *"पिछले हफ़्ते क्या हुआ?"*, *"पिछले 3 दिन की रोग डिटेक्शन दिखाओ"* — Storage_Data इवेंट डेटाबेस से, जब तक इवेंट रखे हैं तब तक। |
