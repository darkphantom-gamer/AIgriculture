...
|------------|------------|----------------------------|
| **`python main.py`** | デフォルト。Raspberry Pi (4 / 5) でもラップトップでも動きます。 | Ultralytics YOLOv8n を CPU + フレームスキップで実行 — 普通の Pi で動作。 |
...
![Meshtastic ↔ FLORA リアル LoRa チャット](../img/meshtastic-flora-proof.jpg)
